<template>
    <div>
        ...
        <!-- 添加热门排行榜入口卡片 -->
        <el-row style="background-color: rgb(255,255,255);padding: 20px;margin-top: 20px;">
            <el-col :span="24">
                <div class="feature-cards">
                    <el-card shadow="hover" class="feature-card" @click.native="goToTrending">
                        <div class="feature-icon">
                            <i class="el-icon-data-line"></i>
                        </div>
                        <div class="feature-content">
                            <h3>热门排行榜</h3>
                            <p>查看实时热门美食排行榜和UV统计数据</p>
                        </div>
                    </el-card>
                    
                    <el-card shadow="hover" class="feature-card" @click.native="route('/hot')">
                        <div class="feature-icon">
...
export default {
    components: { MyContentNetManage, Hot },
    name: "Service",
    data() {
        return {
